...
{
    NSDate *from = [self dateAtStartOfDay];
    NSDate *to = [anotherDate dateAtStartOfDay];
    NSCalendar *gregorianCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *components = [gregorianCalendar components:NSCalendarUnitDay fromDate:from toDate:to options:0];
